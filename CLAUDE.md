...
MODEL POLICY (Token Budget)
 ...
 claude-sonnet-4-6     → complex logic / multi-file
 claude-opus-*         → ห้าม ยกเว้น CGO อนุมัติเป็นลายลักษณ์อักษร
...
## DEPLOY / ROLLBACK (พร้อมใช้ 2026-05-01)
...
# Rollback ฉุกเฉิน
./rollback.sh              # กลับ 1 commit
./rollback.sh abc123       # กลับไป commit ที่ระบุ
